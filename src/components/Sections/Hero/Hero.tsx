      ...
      >
        <Grid item xs={12} sm={10} md={8} lg={7}>
          <Box ref={ref}>
            ...
            >
              Welcome! Explore my software development journey.
            </Typography>
            <Typography
              variant="h2"
            ...
            >
              Hi, I am an aspiring Software Engineer with a passion for solving
              problems, building scalable applications, and growing with
              innovative teams.
            </Typography>
