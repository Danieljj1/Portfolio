...
import { IProjectCard, IProjects } from "../../../Types/Types";
...
const projectsArray: IProjectCard[] = [
  {
    ...
    img: "/images/Spani-Go.png",
    siteUrl: "https://spanish-app-front.onrender.com",
    repoUrl: "https://github.com/Danieljj1/Spanish-App",
  },
  {
    title: "Code Comment Generator",
    description:
      "A tool that automatically adds comments and explanations to code for different skill levels.",
    img: "/images/Code_Comment.png",
    siteUrl: "https://code-comment-c058.onrender.com",
    repoUrl: "https://github.com/Danieljj1/Code_Comment",
  },
        ...
        <Grid container>
          <Grid item sx={centeredStyles}>
            <Typography
              ...
              fontWeight="600"
            >
              Successful Projects I&apos;ve Built
            </Typography>
            <Typography
