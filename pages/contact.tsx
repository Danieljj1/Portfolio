...
const Contact = () => {
  ...
  return (
    <Layout
      title="Daniel Harris-Jordan contact page"
      desc="If you have questions you can contact me at danieljjh2003@gmail.com.com | Or Send a Message through the form."
    >
      <Box
        sx={{
          overflowX: "hidden",
        ...
        >
          <Box
            sx={{
              ...
              backgroundImage: "radial-gradient(#ff8000 2px, transparent 0)",
          ...
          >
            ...
            >
              <ContactBox
                href="mailto:danieljjh2003@gmail.com"
                target="_blank"
                t1="Get in touch"
                t2="Email Address"
                t3="danieljjh2003@gmail.com"
              />
              <ContactBox
                href={`https://www.google.com/maps/place/Greensburg/Pennsylvania/data=!4m2!3m1!1s0x151f17028422aaad:0xcc7d34096c00f970?sa=X&ved=2ahUKEwiK1JSG9or9AhXfUaQEHdUJC40Q8gF6BAgIEAI`}
                target="_blank"
                t1="Location"
                t2="Currently living in"
                t3="Greensburg/Pennsylvania"
              />
              <ContactBox
                target="_blank"
                t1="Contact Directly "
