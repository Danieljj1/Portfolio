...
const Home: NextPage = ({ projectsArray, iconsArray }: any) => {
  ...
  return (
    <Layout
      desc={`Daniel Harris-Jordan, A professional software engineer in Greensburg, Pennsylvania, Can develop all kinds of websites and web/mobile applications according to your professional needs`}
      title="Daniel Harris-Jordan Software Engineer Personal Portfolio Website"
    >
      <Box
        sx={{
          margin: "0 auto",
