  ...
  return (
    <>
      <Head>
        <title>
          {title ||
            "Daniel Harris-Jordan Personal Portfolio | Software Engineer"}
        </title>
        ...
        <meta
          ...
          content={`${
            desc ||
            "Daniel Harris-Jordan personal portfolio, A software engineer and full-stack developer."
          }`}
        />

        <meta
          property="og:title"
          content="Daniel Harris-Jordan Personal Portfolio | Software Engineer"
        />
        ...
        <meta
          ...
          content="Daniel Harris-Jordan | Software Engineer. This is my Portfolio"
        />
...
<meta property="og:type" content="article" /> */}
        ...
        <meta name="author" content="Daniel Harris-Jordan" />
